...
#
    ## multithread here!!!
    ## Make this a function run_single_subject(subject,layout)
    ## what should it return/ write
    ## write a params .npy or edf file
    ## write a y_pred .npy and edf annot file
    ## save a trained classifier
    ## return statistical metrics; ie FPR, F1, etc
    ## to further interpret with FPM etc..
