...
# calculates 59 univariate linear Features using the  univariate_linear_features defined in src univariate_linear_features
...
def run_logreg_subjects(subject, DB, mode="detection", nseizures_train=3, SOP = 30):
    """
